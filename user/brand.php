...
<form action="" method="GET" class="formm">
  ...
  <div class="col-md-4">
    ...
    <input type="text" name="endat" value="<?php if(isset($_GET['endat'])){echo $_GET['endat']; }else{echo "Category";}?>" class="form-control"  placeholder="category">
  </div>
...
$endat = $_GET['endat'];
$sql ="SELECT * FROM `products` WHERE category like '%$endat%' or name like '%$endat%'or description like '%$endat%'";
