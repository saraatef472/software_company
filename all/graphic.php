...
<!-- <br> -->
<div class="alll">
<?php $result = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'graphic' or category = 'graphic design'  or description = 'graphic' or name = 'graphic' or name = 'graphic design' or description = 'graphic design'");
