...
<!-- <br> -->
<div class="alll">
<?php $result = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'interior' or category = 'interior design'  or description = 'interior' or name = 'interior' or name = 'interior design' or description = 'interior design'");
